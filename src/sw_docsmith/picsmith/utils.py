...
def setup_transform():
    ...
    input_dir = os.path.join(current_dir, '../../img-input')
    ebook_input_dir = os.path.join(current_dir, '../../ebook-input')
    ...
    if not os.path.exists(ebook_input_dir):
        os.makedirs(ebook_input_dir)
    ...
    setup_data['ebook_input_dir'] = ebook_input_dir
...
def save_image(pillow_img, orig_filename, gen_filename, output_dir, use_orig=False, slugify=False):
